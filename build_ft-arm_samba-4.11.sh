...
FT_SAMBA_DIR=$HOME/projects/freshtomato-samba4/arm

## path to extracted libtirpc-sources
LIBTIRPC_DIR=$HOME/projects/freshtomato-samba4/libtirpc-1.2.5

## path to extracted gnutls-sources
GNUTLS_DIR=$HOME/projects/freshtomato-samba4/gnutls-3.6.13

## path to extracted samba-sources
SAMBA_DIR=$HOME/projects/freshtomato-samba4/samba-4.11.9
